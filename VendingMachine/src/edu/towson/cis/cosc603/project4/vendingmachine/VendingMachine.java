...
public class VendingMachine {
	...
	//BUG FIX: set INITIAL_BALANCE to 0.00 in place of 0 since value is a double not an int.
	...
	//BUG FIX: replaced "Amount must be >=0" to "amount must be > 0"
	...
	//BUG FIX: set balance to value of 0.00 instead of having no value to prevent potential issues.
